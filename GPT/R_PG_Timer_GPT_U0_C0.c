...
* Limitations  : 
******************************************************************************
* History : 21.04.2016 Version Description
*         :   
******************************************************************************/
...
bool R_PG_Timer_Set_GPT_U0_C0(void)
{
	...
	create_parameters.data2 = PDL_GPT_MODE_TRIANGLE_1 | PDL_GPT_CLK_ICLK_DIV_1;
	create_parameters.data3 = PDL_GPT_IRQ_OU_OVER;
	create_parameters.data6 = PDL_GPT_A_CM_INVERT | PDL_GPT_A_LOW_LOW | PDL_GPT_A_CYCLE_LOW;
	create_parameters.data7 = PDL_GPT_B_CM_INVERT | PDL_GPT_B_HIGH_HIGH | PDL_GPT_B_CYCLE_HIGH;
	create_parameters.data9 = PDL_GPT_BUFFER_CMIC_A_SINGLE | PDL_GPT_BUFFER_CMIC_B_SINGLE;
	create_parameters.data10 = PDL_GPT_DEAD_TIME_ENABLE | PDL_GPT_DEAD_TIME_DOWN_MATCH_UP;
	...
	create_parameters.func5 = Gpt0CmVIntFunc;
	...
	return R_GPT_ControlChannel(
		0,
		PDL_GPT_COUNT_DIRECTION_UP | PDL_GPT_COUNT_DIRECTION_FORCE,
		PDL_GPT_REGISTER_COUNTER | PDL_GPT_REGISTER_CYCLE | PDL_GPT_REGISTER_DEAD_TIME_UP,
		&control_parameters
	);
}
