...
* Include      : 
*
* Declaration  : bool R_PG_Timer_Start_CMT_U1_C3(void)
*
* Function Name: R_PG_Timer_Start_CMT_U1_C3
*
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_HaltCount_CMT_U1_C3(void)
*
* Function Name: R_PG_Timer_HaltCount_CMT_U1_C3
*
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_ResumeCount_CMT_U1_C3(void)
*
* Function Name: R_PG_Timer_ResumeCount_CMT_U1_C3
*
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_GetCounterValue_CMT_U1_C3(uint16_t * counter_val)
*
* Function Name: R_PG_Timer_GetCounterValue_CMT_U1_C3
*
...
* Include      : 
*
* Declaration  : bool R_PG_Timer_SetCounterValue_CMT_U1_C3(uint16_t counter_val)
*
* Function Name: R_PG_Timer_SetCounterValue_CMT_U1_C3
*
