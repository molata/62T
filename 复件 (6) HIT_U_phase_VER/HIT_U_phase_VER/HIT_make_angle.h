...
extern float HIT_HEIHEI;

extern int HIT_sitaintf_curr_int;
extern float HIT_sitaintf_curr_mech_f;
extern int HIT_sitaintf_curr_mech_int;

extern float HIT_a_trans_hall[4] ;
extern float HIT_b_trans_hall[4] ;
extern float HIT_c_trans_hall[4] ;
extern unsigned int HIT_ad_count;
extern unsigned short HIT_ceshiad_p_c[4];
extern unsigned short HIT_ceshiad_n_c[4];
