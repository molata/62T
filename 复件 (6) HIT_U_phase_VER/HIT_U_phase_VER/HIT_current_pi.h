...
extern float HIT_Ud;
extern float HIT_Uq;
extern float HIT_U_u;
extern float HIT_U_v;
extern float HIT_U_w;
...
extern float HIT_curren_ab_q;  //the min value of integralter
extern float HIT_curren_aa_d;  //the max value of integralter 
extern float HIT_curren_ab_d;  //the min value of integralter
...
#define HIT_PWMOUTULIM 3464//1732//762//450//900//866//1732/*4000:output Max*86.6%*/
