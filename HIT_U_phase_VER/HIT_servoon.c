...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    		if(HIT_qa == 736000000)//15550020140107//155804)//1553)//288000000//36000000//106500///////20  1ms
			{
			//	if(HIT_cur_test == 2)
				{
					HIT_ready_go = 0;
			...
			if(HIT_qa>=  736000001)//155805)//288000001//36000001//106501
			{
				...
				GPT2.GTONCR.WORD = 0X0000;
				HIT_qa = 736000000;//155804;//288000001;//36000001;//106501;	
			}
			else
			{
				HIT_qa++;			
