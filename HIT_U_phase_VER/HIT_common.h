...
float HIT_d_hall;
float HIT_q_hall;
signed int HIT_sitadf_int = 0x7003;//0x72ef;//0x7330;//46837;//5854;//0x9769;//0x2968;//0xD26E;//0xF6AE;//0xD782;//0xD962;//0xD818;//0xADD9;//0xD6AE;//0x2d78;//0X2A89;//0X312D;//ce shi modify 2012.4.2
...
float HIT_poles = 12;//12.0;//1.5;//12.0;//5.0;//1.0;
float HIT_curr_sen = 203;//205;//100;//4.167;//100;//100;//66;//185;//66;//mV/A
float HIT_iq_ref = 0.0;//1;//2;//1;//2;
float HIT_id_ref = 1;//0.5;
float HIT_pwm_off_vector_min = 40;
float HIT_pwm_off=240;//130;//360;//240;//120;//360;
float HIT_pwm_deadoff = 40;//80;//120;//3.5us
float HIT_lm = 0.000008;//0.00008;//0.00224;//0.0007;//0.025;//0.000189;//0.025;//0.000189;//0.00126;//0.000165;//0.00002118;//0.0001;//0.000165;//0.02118;//0.000065;//0.025;//0.000065;
float HIT_Lq = 0.00004;//0.00006;//0.0000007;//0.00224;//0.0007;//0.025;//0.07924391;//0.000189;//0.07924391;//0.000189;//0.00126;//0.000165;//0.00002118;//0.0001;//0.000165;//0.02118;//0.000065;//0.07924391;//0.2;//0.07924391;
float HIT_Ld = 0.00004;//0.00006;//0.0000007;
float HIT_Rs = 0.4;//0.001;//1.5;//11.2;//1.5;//7.771897;//8.3677;//7.771897;//0.54;//0.07912;//7.771897;//0.07912;//7.771897;//7.6253//7.771897//4.2
float HIT_Ts = 0.00005;
float HIT_ki = 800;//200;//380;//200;//300;//1040;//1000;
float HIT_iq_ki=800;
float HIT_kv = 5000;//1600;//800;//1400;//800;//1200;//1045;//4000;
float HIT_iq_kv=77500;//800;
...
float HIT_WL_T_factor = 0.015;//4.941;//0.03;//0.4;//0.012;//0.4;//0.012; 
...
int HIT_pwm_full = 1000;//2000;//4000;//2000;//880;
...
float HIT_iq_ref_mech_max = 2.5;//25;40dianji//20;//15;//20140428
...
#define HIT_PWM_FULL 1000//2000//4000//2000//880
