...
float HIT_d_hall;
float HIT_q_hall;
signed int HIT_sitadf_int = 0x72ef;//6090;//6123;//0x72ef;//6123;//0xbf5a;//0x72ef;//0x7330;//46837;//5854;//0x9769;//0x2968;//0xD26E;//0xF6AE;//0xD782;//0xD962;//0xD818;//0xADD9;//0xD6AE;//0x2d78;//0X2A89;//0X312D;//ce shi modify 2012.4.2
