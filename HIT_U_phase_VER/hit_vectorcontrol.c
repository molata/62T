...
float HIT_vector_pwm_center_f = 460;//860;
...
float HIT_UH_lim_wjw = 950;//1760;//3760=(4000-240)--半周期控制时测得的脉宽最大限制(半周期1us-80,由于死区设定为3us)
float HIT_UL_lim_wjw = 20;//40;//半周期控制时测得的最小可实现脉宽
...
//		HIT_pwm_af = (HIT_Uu_3to2/HIT_Um/HIT_voltage_utility*HIT_vector_pwm_center_f+HIT_vector_pwm_center_f+40);//*HIT_Vol_adj_fac;
		HIT_pwm_af = (HIT_Uu_3to2/HIT_Um*500 + HIT_vector_pwm_center_f+40);//*HIT_Vol_adj_fac;
...
//		HIT_pwm_bf = (HIT_Uv_3to2/HIT_Um/HIT_voltage_utility*HIT_vector_pwm_center_f+HIT_vector_pwm_center_f+40);//*HIT_Vol_adj_fac;
		HIT_pwm_bf = (HIT_Uv_3to2/HIT_Um*500 + HIT_vector_pwm_center_f+40);//*HIT_Vol_adj_fac;
...
//		HIT_pwm_cf =  (HIT_Uw_3to2/HIT_Um/HIT_voltage_utility*HIT_vector_pwm_center_f+HIT_vector_pwm_center_f+40);//*HIT_Vol_adj_fac;
		HIT_pwm_cf =  (HIT_Uw_3to2/HIT_Um*500 + HIT_vector_pwm_center_f+40);
/*dead off*/
